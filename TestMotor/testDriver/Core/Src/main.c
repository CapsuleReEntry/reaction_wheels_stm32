...
/**
  ...
  */
	...
	#define BLUE_WIRE GPIO_PIN_12 
	#define PINK_WIRE GPIO_PIN_13
	#define YELLOW_WIRE GPIO_PIN_14
	#define ORANGE_WIRE GPIO_PIN_15
...
void SimpleDirL(uint32_t delay);
/* Private includes ----------------------------------------------------------*/
...
void doOneStep(int timeDelay) {
    HAL_GPIO_WritePin(GPIOB, PINK_WIRE, GPIO_PIN_SET);
		HAL_GPIO_WritePin(GPIOB, YELLOW_WIRE, GPIO_PIN_SET);
		HAL_GPIO_WritePin(GPIOB, BLUE_WIRE, GPIO_PIN_RESET);
		HAL_GPIO_WritePin(GPIOB, ORANGE_WIRE, GPIO_PIN_RESET);
		HAL_Delay(timeDelay);
		HAL_GPIO_WritePin(GPIOB, PINK_WIRE, GPIO_PIN_RESET);
		HAL_GPIO_WritePin(GPIOB, YELLOW_WIRE, GPIO_PIN_RESET);
		HAL_GPIO_WritePin(GPIOB, BLUE_WIRE, GPIO_PIN_RESET);
		HAL_GPIO_WritePin(GPIOB, ORANGE_WIRE, GPIO_PIN_SET);
		HAL_Delay(timeDelay);
		HAL_GPIO_WritePin(GPIOB, PINK_WIRE, GPIO_PIN_RESET);
		HAL_GPIO_WritePin(GPIOB, YELLOW_WIRE, GPIO_PIN_SET);
		HAL_GPIO_WritePin(GPIOB, BLUE_WIRE, GPIO_PIN_RESET);
	  ...
	  HAL_GPIO_WritePin(GPIOB, PINK_WIRE, GPIO_PIN_RESET);
		HAL_GPIO_WritePin(GPIOB, YELLOW_WIRE, GPIO_PIN_RESET);
		HAL_GPIO_WritePin(GPIOB, BLUE_WIRE, GPIO_PIN_SET);
		HAL_GPIO_WritePin(GPIOB, ORANGE_WIRE, GPIO_PIN_RESET);
		HAL_Delay(timeDelay);
}

void doOtherStep(int timeDelay) {
	  HAL_GPIO_WritePin(GPIOB, PINK_WIRE, GPIO_PIN_RESET);
		HAL_GPIO_WritePin(GPIOB, YELLOW_WIRE, GPIO_PIN_RESET);
		HAL_GPIO_WritePin(GPIOB, BLUE_WIRE, GPIO_PIN_SET);
		HAL_GPIO_WritePin(GPIOB, ORANGE_WIRE, GPIO_PIN_SET);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12|GPIO_PIN_13|GPIO_PIN_14|GPIO_PIN_15|GPIO_PIN_11|GPIO_PIN_10|GPIO_PIN_1|GPIO_PIN_0, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13, GPIO_PIN_RESET);
	HAL_GPIO_WritePin(GPIOA, GPIO_PIN_6|GPIO_PIN_7, GPIO_PIN_RESET);
	
  /*Configure GPIO pins : PB12 PB13 PB14 PB15 */
  GPIO_InitStruct.Pin = GPIO_PIN_12|GPIO_PIN_13|GPIO_PIN_14|GPIO_PIN_15|GPIO_PIN_11|GPIO_PIN_10|GPIO_PIN_1|GPIO_PIN_0;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
	
	  /*Configure GPIO pins : A7 A6*/
